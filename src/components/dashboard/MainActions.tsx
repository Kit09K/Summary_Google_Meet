          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">เลือกไฟล์บันทึกการประชุมจาก Google Drive</p>
              </div>
            </div>
            <Button
              variant="outline"
          ...
          {recordingsLoading ? (
            <div className="flex items-center justify-center py-8">
              <div className="text-center">
                ...
                <p className="mt-2 text-sm text-gray-500">กำลังโหลดไฟล์จาก Google Drive...</p>
              </div>
            </div>
          ) : recordingsError ? (
            ...
            <div className="text-center py-8">
              ...
              <p className="text-sm text-gray-500 mb-3">ไม่พบไฟล์บันทึกการประชุมใน Google Drive</p>
              <Button variant="outline" size="sm" onClick={handleRefresh}>
                ลองโหลดใหม่
              </Button>
            </div>
      ...
      <Card>
        <div className="flex items-center space-x-3 mb-4">
          ...
          <div>
            ...
            <p className="text-sm text-gray-600">อัปโหลดไฟล์ท้องถิ่นเพื่อทำสรุป</p>
          </div>
        </div>
        ...
        <div className="space-y-4 mb-4">
          ...
          <div>
            ...
            <label className="block">
              ...
              >
                ...
                <p className="text-xs text-gray-500 mt-2">รองรับไฟล์ MP3, MP4, WAV, MOV (สูงสุด 500MB)</p>
              </div>
            </label>
          </div>
            ...
            <div className="bg-green-50 border border-green-200 rounded-lg p-3">
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-sm font-medium text-green-800">เลือกไฟล์จาก Google Drive แล้ว</span>
                </div>
                <button
              ...
              <p className="text-xs text-green-600 mt-1">
                {recentRecordings.find(r => r.id === selectedDriveFile)?.title}
              </p>
            </div>
          )}
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-3">
            <div className="flex items-start space-x-2">
              ...
              <div>
                <p className="text-sm font-medium text-blue-800">รองรับไฟล์ประเภท</p>
...
const GoogleDriveRecordingItem: React.FC<{ 
  ...
  const formatFileSize = (size: string) => {
    ...
    if (!isNaN(numSize)) {
      ...
      if (numSize < 1024 * 1024 * 1024) return `${Math.round(numSize / (1024 * 1024))} MB`;
        ...
        <div className="min-w-0 flex-1">
          ...
          <div className="flex items-center space-x-2 mt-1">
            <p className={`text-xs ${
              ...
              {formatFileSize(recording.size)} • {recording.duration} • {recording.date}
            </p>
          </div>
